...
1. the 工作簿主产物, generated by `scripts/export_workbook.py <graph> --mode standard --format auto --manifest <manifest>`;
2. the Markdown 配套报告, generated from the same graph by `scripts/export_superleads_markdown.py <graph> --route bulk_customer_development --output <report>.md --format json`.
