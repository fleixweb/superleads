...
- **产品出海市场分析**：围绕一个产品进入或出口到某个国家/地区，整理 Google Trends 长期搜索兴趣、公开市场资料、线上价格参考、季节/节假日、准入合规、认证/测试/注册/标签要求、原产地证明、进口税费、出口国要求、运输路线和近期外部因素。
...
正式客户开发、客户背调和产品出海市场分析需要当前 Agent 同时具备联网搜索与打开可记录来源的能力。若当前环境缺少其中任一能力，Superleads 会明确要求切换到具备 Web Search 和来源打开能力的环境，而不会把“搜索计划”或空报告当作交付。

因此，你可以复查客户开发过程、接手未完成的背调、删掉不可靠客户，并把可用资料交给销售继续跟进。做产品出海市场分析时，系统也会把默认出口申报国、原产国/制造来源、实际起运地/起运港分开写清楚；目标国是否要求原产地证明、认证、测试、注册、标签或包装文件会按公开权威来源判断，用户有没有现成证书只是材料状态，不反推法规要求。
