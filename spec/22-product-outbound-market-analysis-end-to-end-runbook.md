...
| 8 | Observation | EvidenceCard | 按证据类型生成已核实、候选、派生、待确认等状态 | 适用范围不匹配、日期缺失、字段冲突则降级/冲突 |
...
| 目的国准入/税费 | 目的国准入、税费与进口规则 | 准入/标签/税费 EvidenceCard、候选归类缺口 | 候选税号是否变最终税率，标签规则是否错套 |
...
| 美国税费 | 查候选 HTSUS、裁定、附加税入口 | 官方税则、海关裁定、贸易救济入口 | 不计算最终税率 |
...
| 美国标签 | 查纺织成分、护理、原产地标识等规则入口 | 美国主管来源 / 纺织标签指南 | 不写实物标签已合规 |
| 美国税费 | 查候选 HTSUS、裁定、贸易救济入口 | 官方税则、海关裁定、贸易救济入口 | 不写最终归类或税率 |
...
| 5. 准入与标签 | 展示目的国规则和缺口 | 来源、适用条件、待确认文件 |
