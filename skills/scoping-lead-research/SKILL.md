...
- Use user-facing output modes: 发现候选池, 标准开发名单, 联系方式优先, 补全已有表格, 客户背调报告. `客户背调报告` currently means a research-draft data contract only; this local deployment does not provide `full_review_package`.
