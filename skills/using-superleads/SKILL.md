...
以下不属于准入条件：官网是否列出精确料号、公开可证的进口或海关角色、采购意愿、商业价值高低。官网未列料号和未公开进口身份属于询盘核实项，不能单独把候选降级、排除或写成不合格。确实缺少对象或证据链时，如实说明缺口；若唯一缺口是上述询盘项，说明其公开信息原理上不可得，并给出补充公开核验或询盘核实的继续方式。
